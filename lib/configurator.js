        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (getArchiveType(downloadURL)) {
                ...
                case ArchiveType.TarGz:
                    extractLocation = yield tc.extractTar(downloadPath, tempDir);
                    break;
                // return this.moveToPath(path.join(archivePath, this.pathInArchive));
                case ArchiveType.Zip:
                    extractLocation = yield tc.extractZip(downloadPath, tempDir);
                    break;
                // return this.moveToPath(path.join(archivePath, this.pathInArchive));
                case ArchiveType.SevenZ:
                    extractLocation = yield tc.extract7z(downloadPath, tempDir);
                    break;
                // return this.moveToPath(path.join(archivePath, this.pathInArchive));
            }
